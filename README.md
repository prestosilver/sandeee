...
* **Q: why are there so many commits starting with "meta" here**
  ...
  **A:** TLDR; They are ignored in autogenerated changelogs, and need to be tagged.
  ...
  This is also why the [csv file here](content/data/changelog_ignore.txt) exists, for When I forget the tag, or have a typo, I can revise a message for just the changelog while preserving git history.
  ...
  * Something that is redundant IE. something that fixes a bug that I thought I already fixed since the last major update.
