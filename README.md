...
* **Q: why are there so many commits starting with "meta" here**
  ...
  **A:** TLDR; They are ignored in autogenerated changelogs, and need to be tagged.
  ...
  - Something that is redundant IE. something that refixes a bug that I thought I already fixed since the last major update.
  
  Also note these commits are still counted in build version numbers.

* **Q: Can I build and run a non demo build of SandEEE**

  **A:** Yes, I wont help you get it working but you run code from this repo even if you dont have the game on itch or steam. The game will be free of course.
