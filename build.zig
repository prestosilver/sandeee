...
const eonTestsFiles = [_][]const u8{ "color", "bugs", "pong", "paint", "tabletest", "heaptest", "stringtest", "paren" };
...
const pngImageFiles = [_][]const u8{ "icons", "ui", "notif", "bar", "email", "explorer", "window", "wall", "barlogo", "cursor" };
